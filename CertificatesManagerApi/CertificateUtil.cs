...
// source: https://github.com/rwatjen/AzureIoTDPSCertificates/tree/master/src/DPSCertificateTool
namespace CertificatesManager
{
    class CertificateUtil
    {
        ...
        internal static X509Certificate2 CreateCaCertificate(string subjectName, string certificatePassword, X509Certificate2 issuingCa)
        {
